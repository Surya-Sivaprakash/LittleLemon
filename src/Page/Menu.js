...
function Menu() {
  const menuItems = [
    ...
    { id: 5, name: "Roasted Chicken", price: 15, photo: Item5 },
    { id: 6, name: "Roasted Chicken", price: 15, photo: Item1 },
  ];
  ...
  return (
    <div>
      <div className="bg-emerald-900">
        <h2 className="text-center mt-4 mb-4 text-white">Menu</h2>
                ...
                (item) =>
                  cart[item.id] > 0 && (
                    <li key={item.id} className="cart-item">
                      <span>
                        {item.name}: {cart[item.id]} x ${item.price} = $
